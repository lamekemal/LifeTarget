...
public class resto implements Serializable {
    public int id;
    public String title, adress, horaire, siteweb, description, longdescription, uniqueid, rating, service, pointfort, pointfaible, prinpimage, galeryOne, galerytwo, galeryfor, galeryfive, galerysix, mets, modified;

    public resto() {
    }

    public resto(int id, String title, String adress, String horaire, String siteweb, String description, String longdescription, String uniqueid, String rating, String service, String pointfort, String pointfaible, String prinpimage, String galeryOne, String galerytwo, String galeryfor, String galeryfive, String galerysix, String mets, String modified) {
        this.id = id;
        this.title = title;
        this.adress = adress;
