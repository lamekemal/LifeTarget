...
public class Appintro extends  AppIntro2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sliderPage1.setDescription("Découvrez comment cette application va changez votre vie");
        ...
        sliderPage2.setDescription("Explorer les restaurants & hotels  comme si vous y étiez, obtenez des bons de réduction, des réservations et bien d'autres avantages...");
        ...
        sliderPage3.setDescription("Visiter à travers l'application des lieux uniques, LiT vous accompagne partout");
        sliderPage3.setImageDrawable(R.drawable.litp);
        sliderPage3.setTitleColor(getResources().getColor(R.color.TourismFont));
        sliderPage3.setDescColor(getResources().getColor(R.color.TourismFont));
        sliderPage3.setBgColor(getResources().getColor(R.color.Tourism));
        addSlide(AppIntroFragment.newInstance(sliderPage3));

        SliderPage sliderPage4 = new SliderPage();
        sliderPage4.setTitle("Inscrivez-vous à Lit");
        ...
        sliderPage4.setDescColor(getResources().getColor(R.color.white));
            sliderPage4.setDescription("Inscrivez-vous à à Lit et découvrez ces 56 fonctionnalités qui vont changer votre vie");
