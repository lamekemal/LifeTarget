...
public class RegisterActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputnumero = (EditText) findViewById(R.id.numero);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty()) {
                    registerUser(name, email, password,numero);
                } else {
                    Toast.makeText(getApplicationContext(),
                            "Entrez des informaton correcte", Toast.LENGTH_LONG)
                            .show();
                }
            }
        });
    ...
    private void registerUser(final String name, final String email,
                              final String password,final String numero) {
        ...
        StringRequest strReq = new StringRequest(Method.POST,
                databaseContract.AppConfig.URL_REGISTER, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        JSONObject user = jObj.getJSONObject("lfeappusers");
                        String name = user.getString("name");
                        String email = user.getString("email");
                        String numero = user.getString("settings");
                        String created_at = user
                                .getString("created_at");

                        // Inserting row in users table
                        db.addUser(name, email, numero, uid, created_at);

                        Toast.makeText(getApplicationContext(), "Bien sauvegarder", Toast.LENGTH_LONG).show();
